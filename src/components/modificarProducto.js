...
export const ModificarProducto = () => {
  ...
  function getData() {
    fetch(`https://api-artesania-backend.up.railway.app/productos/${params._id}`)//obtengo los datos del producto enviando el id al backend
      .then((resp) => resp.json())
      .then((resp) => {
  ...
  function modificarProducto() {
    ...
    fetch(`https://api-artesania-backend.up.railway.app/modificarProducto/${params._id}`, {//envio el id del producto a modificar al backend
      method: "PUT",
      body: datosJSON,
      headers: {
